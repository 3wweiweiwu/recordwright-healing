...
//   beforeEach(
//     "Read and return the Snapshot of the web page in HtmlSnapshotCompresed",
//     async () => {
//       compressionComplete = new HtmlSnapshotCompresed(
//         JSON.stringify(snapshotJson)
//       );
//       baselineComplete = compressionComplete.parse(
//         JSON.stringify(snapshotJson)
//       );
//       compressionNode = new HtmlSnapshotCompresed(
//         JSON.stringify(snapshotJsonNode)
//       );
...
//           newRow[0].text,
//           /\n\s+/g,
//           `text musnt match with /\\n\\s+/g`
//         );
//         assert.equal(
//           newRow[0].text,
//           result,
//           `Text must keep information for that doesnt match  /\\n\\s+/g`
//         );
//       }).timeout(999);
...
//       Math.random() * compressionNode.atomicNodeMatrix.lenght
//     );
//     describe("Test getNodeInformationById function", () => {
//       it("Single node", async () => {}).timeout(99999);
//       it("Multiple node", async () => {}).timeout(99999);
//     });
//   });
//   it("should compress snapshot with happy path", async () => {}).timeout(
//     1000000
//   );
// });
